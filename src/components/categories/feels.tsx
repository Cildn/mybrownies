...
export default function FeelsPage() {
  ...
  const filteredProducts = (productsData?.products || [])
    .filter((product) => {
      const matchesCategory = product.category?.name?.toLowerCase() === "Feels";
  ...
  const filteredCollections = (collectionsData?.collections || [])
    .filter((collection) => {
      const matchesCategory = collection.category?.name?.toLowerCase() === "Feels";
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      >
        ...
        >
          <h1 className="text-6xl font-bold">Discover Luxurious Feels</h1>
