...
import { GET_COLLECTION_BY_ID } from "@/lib/graphql/queries/collections";
...
const CollectionPage = () => {
  ...
  const { tabs, howItWorksContent } = collection.additionalInfo
    ? parseAdditionalInfo(collection.additionalInfo)
    : { tabs: [], howItWorksContent: "" };
        ...
        <div className="flex flex-col lg:flex-row gap-10 mb-16">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {collection.products?.slice(0, 4).map((p: Product) => (
